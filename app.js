...
class App {
    ...
    setupVR() {
        ...
        function onSelectStart() {
            ...
            const intersections = getIntersections(this);
            if (intersections.length > 0) {
                this.attach(intersections[0].object);
                this.userData.selected = intersections[0].object;
            }
        }
        ...
        function onSelectEnd() {
            ...
            if (this.userData.selected) {
                self.room.attach(this.userData.selected);
    ...
    getIntersections(controller) {
        ...
        return this.raycaster.intersectObjects(this.room.children, false);
    }
